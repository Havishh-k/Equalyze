...
import { Scale, Mail, Lock, Eye, EyeOff, ArrowRight, UserPlus } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute bottom-1/3 -left-40 w-[500px] h-[500px] rounded-full opacity-10 blur-3xl"
      ...
      <div className="w-full max-w-md mx-4 animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p style={{ color: "var(--text-secondary)" }} className="text-sm">
            Create your bias detection account
          </p>
        </div>
